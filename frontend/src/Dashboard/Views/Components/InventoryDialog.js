        ...
        <Dialog open={dialogOpen} onClose={closeDialog} disableBackdropClick>
            ...
            <DialogContent>
                <Grid container spacing={2} alignItems="center">
                    ...
                    <Grid item xs={3}>
                        <FormControlLabel
                            control={<Checkbox checked={inputs.surplus} value={inputs.surplus} onClick={changeInput} name="surplus" color="primary" />}
                            label="Surplus"
                            labelPlacement="end"
                        />
                    </Grid>
                    <Grid item xs={3}>
                        <FormControlLabel
                            control={<Checkbox checked={inputs.taxable} value={inputs.taxable} onClick={changeInput} name="taxable" color="primary" />}
                            label="Taxable"
                            labelPlacement="end"
                        />
                    </Grid>
                    <Grid item xs={3}>
                        <FormControlLabel
                            control={<Checkbox checked={inputs.expendable} value={inputs.expendable} onClick={changeInput} name="expendable" color="primary" />}
                            label="Expendable"
                            labelPlacement="end"
                        />
                    </Grid>
                    <Grid item xs={3} >
                        <FormControlLabel
                            control={<Checkbox checked={inputs.jerseyNumbers} value={inputs.jerseyNumbers} onClick={changeInput} name="jerseyNumbers" color="primary" />}
                    ...
                    <Grid item xs={4}>
                        <FormControl variant="outlined" margin="normal" required fullWidth>
                            ...
                            <Select
                                ...
                                labelId="size-label"
                                label="Size"
                                value={sportSize} onChange={handleSportSizeChange}
                            >
                                {sportSizes.map(size =>
                    ...
                    <Grid item xs={4}>
                        <FormControlLabel
                            control={<Checkbox checked={inputs.alertQuantity} value={inputs.alertQuantity} onClick={changeInput} name="alertQuantity" color="primary" />}
